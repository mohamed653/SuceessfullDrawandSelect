#include "ActionAddHexa.h"
#include "..\Figures\HEXA.h"

#include "..\ApplicationManager.h"

#include "..\GUI\GUI.h"

ActionAddHexa::ActionAddHexa(ApplicationManager* pApp) :Action(pApp)
{}

//Execute the action
void ActionAddHexa::Execute()
{
	Point P1, P2;
	...
	HEXA* H = new HEXA(topLeft, bottomright, HexGfxInfo);
